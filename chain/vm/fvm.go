...
func getMethodType(to address.Address, method abi.MethodNum) string {
	...
	default:
		...
		if isMiner(to) {
			...
			case builtin.MethodsMiner.InternalSectorSetupForPreseal:
				return "InternalSectorSetupForPreseal"
			...
			case builtin.MethodsMiner.ProveCommitSectorsNI:
				return "ProveCommitSectorsNI"
			default:
