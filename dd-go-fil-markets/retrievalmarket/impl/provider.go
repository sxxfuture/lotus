...
type Provider struct {
	...
	ddPieceStore piecestore2.DDPieceStore //DD add
}
...
func NewProvider(minerAddress address.Address,
	...
	/*DD begin*/
	var newOptions []RetrievalProviderOption
...
func (p *Provider) HandleQueryStream(stream rmnet.RetrievalQueryStream) {
	...
	pieceInfo, isUnsealed, err := p.getPieceInfo(ctx, query.PayloadCID, pieceCID) //DD modify
	if err != nil {
