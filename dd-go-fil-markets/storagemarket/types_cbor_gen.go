...
func (t *DataRef) MarshalCBOR(w io.Writer) error {
	...
	if _, err := w.Write([]byte{165 + 3}); err != nil { //DD modify
		return err
	}
	...
	/*DD add*/
	//IsFromUser
	if len("IsFromUser") > cbg.MaxLength {
		return xerrors.Errorf("Value in field \"IsUnseal\" was too long")
	}

	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("IsFromUser"))); err != nil {
		return err
	}
	if _, err := io.WriteString(w, string("IsFromUser")); err != nil {
		return err
	}

	if err := cbg.WriteBool(w, t.IsFromUser); err != nil {
		return err
	}

	//FileRemoteUrl
	if len("FileRemoteUrl") > cbg.MaxLength {
		return xerrors.Errorf("Value in field \"FileRemoteUrl\" was too long")
	}

	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("FileRemoteUrl"))); err != nil {
		return err
	}
	if _, err := io.WriteString(w, string("FileRemoteUrl")); err != nil {
		return err
	}

	if len(t.FileRemoteUrl) > cbg.MaxLength {
		return xerrors.Errorf("Value in field t.FileRemoteUrl was too long")
	}

	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len(t.FileRemoteUrl))); err != nil {
		return err
	}
	if _, err := io.WriteString(w, string(t.FileRemoteUrl)); err != nil {
		return err
	}

	//FileHash
	if len("FileHash") > cbg.MaxLength {
		return xerrors.Errorf("Value in field \"FileHash\" was too long")
	}

	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("FileHash"))); err != nil {
		return err
	}
	if _, err := io.WriteString(w, string("FileHash")); err != nil {
		return err
	}

	if len(t.FileHash) > cbg.MaxLength {
		return xerrors.Errorf("Value in field t.FileHash was too long")
	}

	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len(t.FileHash))); err != nil {
		return err
	}
	if _, err := io.WriteString(w, string(t.FileHash)); err != nil {
		return err
	}
	/*DD end*/
