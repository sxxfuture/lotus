...
type Worker interface {
	...
	AddPieceExt(ctx context.Context, sector storage.SectorRef, pieceSizes []abi.UnpaddedPieceSize, newPieceSize abi.UnpaddedPieceSize, pieceData storage.Data, extInfo map[string]interface{}) (storiface.CallID, error) //perm:admin //DD add
