...
type WorkerStruct struct {
	Internal struct {
		AddPieceExt func(p0 context.Context, p1 storage.SectorRef, p2 []abi.UnpaddedPieceSize, p3 abi.UnpaddedPieceSize, p4 storage.Data, extInfo map[string]interface{}) (storiface.CallID, error) `perm:"admin"` //DD add
...
/*DD begin*/
func (s *WorkerStruct) AddPieceExt(p0 context.Context, p1 storage.SectorRef, p2 []abi.UnpaddedPieceSize, p3 abi.UnpaddedPieceSize, p4 storage.Data, extInfo map[string]interface{}) (storiface.CallID, error) {
	if s.Internal.AddPieceExt == nil {
		return *new(storiface.CallID), ErrNotSupported
	}
	return s.Internal.AddPieceExt(p0, p1, p2, p3, p4, extInfo)
}
/*DD end*/
