...
/*DD begin*/
func (t *trackedWorker) AddPieceExt(ctx context.Context, sector storage.SectorRef, pieceSizes []abi.UnpaddedPieceSize, newPieceSize abi.UnpaddedPieceSize, pieceData storage.Data, extInfo map[string]interface{}) (storiface.CallID, error) {
	return t.tracker.track(ctx, t.execute, t.wid, t.workerInfo, sector, sealtasks.TTAddPiece, func() (storiface.CallID, error) {
		return t.Worker.AddPieceExt(ctx, sector, pieceSizes, newPieceSize, pieceData, extInfo)
	})
}
