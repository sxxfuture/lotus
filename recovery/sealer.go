...
func (ssb *SectorSealer) SnapUp(ctx context.Context, sector storiface.SectorRef, pieces []abi.PieceInfo) (err error) {

	_, err = ssb.sb.ReplicaUpdate(ctx, sector, pieces)
	if err != nil {
		return err
	}
